...
build module executes untrusted upstream build code and sees the repository
public key and ephemeral build key; merge validation remains network-free before
signing, and the persistent repository signing key is mounted only into the
