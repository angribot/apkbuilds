...
fetch/rebase/push retries and no force-push. This preserves successful package
origin updates independently while discarding failed or unpublished changes at
the package origin boundary; build jobs remain parallel per architecture and
